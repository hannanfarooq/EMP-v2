...
export default function AddCompany({ refetchCompanies, handleClose }) {
  ...
  const handleUploads = async () => {
    ...
    for (let file of files) {
      try {
        setProgress(0); // Reset progress before each upload
  
        // Upload the file and get the URL from S3
        const uploadUrl = await uploadImageAndGetURL(file.file);
    ...
    setProgress(null); // Reset progress after all uploads
  };
