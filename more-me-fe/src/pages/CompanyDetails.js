...
export default function CompanyDetails() {
  ...
  const fetchCompanyUser = async () => {
    ...
    if (companyData?.data) setData(companyData?.data)
    else toast.error('Error occured while fetcing user data!')
  };
  ...
  const fetchCompanyData = async () => {
    ...
    if (companyData?.data) setCompanyData(companyData?.data)
    else toast.error('Error occured while fetcing company data!')
  }
                    ...
                    .map((row) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {storedUserData?.user?.role === 'admin' && <TableCell align="right">
                            <IconButton
                              size="large"
                              color="inherit"
                              onClick={(event) => {
